...
class _ {
  ...
  onAdd(t, e) {
    ...
    const i = `
      ...
      R = `
          ...
          `,
      h = p(e, F);
    if (!h) throw new Error('error: computation vertex shader not created');
    const c = b(e, R);
    if (!c) throw new Error('error: computation fragment shader not created');
    if (((this.computationProgram = x(e, h, c)), !this.computationProgram))
    ...
    const m = p(e, i);
    if (!m) throw new Error('error: drawing vertex shader not created');
    const d = b(e, u);
    if (!d) throw new Error('error: drawing fragment shader not created');
    if (((this.drawProgram = x(e, m, d)), !this.drawProgram))
    ...
    const w = this.textureCoverSameAreaAsROI ? f : [1, 1, -1, 1, 1, -1, -1, -1];
    ...
    (this.indicesNumber = E.length),
      ...
      e.bufferData(e.ELEMENT_ARRAY_BUFFER, new Uint8Array(E), e.STATIC_DRAW),
    ...
    this.data.forEach((a) => {
      const s = T.MercatorCoordinate.fromLngLat(a);
      this.points.push([s.x, s.y, a.val]),
        a.val < o && (o = a.val),
        a.val > n && (n = a.val);
    }),
      (o = o < this.minValue ? o : this.minValue),
      (n = n > this.maxValue ? n : this.maxValue),
  ...
  prerender(t, e) {
    ...
    for (let i = 0; i < this.points.length; i += 1) {
      ...
      t.uniform1f(this.uUi, u[2]),
        ...
        t.vertexAttribPointer(this.aPositionComputation, 2, t.FLOAT, !1, 0, 0),
  ...
  render(t, e) {
    ...
    t.useProgram(this.drawProgram),
      ...
      t.uniform2f(this.uScreenSizeDraw, this.canvas.width, this.canvas.height),
...
exports.MapboxInterpolateHeatmapLayer = _;
exports.default = _;
