...
class P {
  ...
  onAdd(t, e) {
    ...
    this.data.forEach((a) => {
      ...
      (u = u > this.maxValue ? u : this.maxValue),
  ...
  prerender(t, e) {
    ...
    for (let i = 0; i < this.points.length; i += 1) {
      ...
      if (!n) throw new Error(`error: point not found at index: ${i}`);
      t.uniform1f(this.uUi, n[2]),
        t.uniform2f(this.uXi, n[0], n[1]),
...
export { P as MapboxInterpolateHeatmapLayer, P as default };
